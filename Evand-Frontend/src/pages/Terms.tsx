...
const Terms = () => {
  const sections = [
    {
      title: "پذیرش شرایط",
      content: "با استفاده از سرویس Evand، شما موافقت خود را با این شرایط و ضوابط اعلام می‌کنید. اگر با هر بخشی از این شرایط موافق نیستید، لطفاً از استفاده از سرویس خودداری کنید.",
    },
    {
      title: "تعریف سرویس",
      content: "Evand یک پلتفرم آنلاین برای ایجاد، مدیریت و شرکت در رویدادهاست. ما ابزارهایی برای برگزارکنندگان و شرکت‌کنندگان رویداد فراهم می‌کنیم تا تجربه بهتری داشته باشند.",
    },
    {
      title: "حساب کاربری",
    ...
    {
      title: "مالکیت معنوی",
      content: "تمامی محتوا، طراحی، لوگو و نرم‌افزار Evand تحت حمایت قوانین مالکیت معنوی است. استفاده غیرمجاز از این موارد ممنوع است.",
    },
    {
      title: "محدودیت مسئولیت",
      content: "Evand در قبال خسارات ناشی از استفاده یا عدم امکان استفاده از سرویس، از دست رفتن داده‌ها یا هرگونه خسارت غیرمستقیم مسئولیتی ندارد.",
    },
    {
